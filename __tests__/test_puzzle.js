...
let Puzzle = require("../src/puzzle").Puzzle;
let Position = require("../src/position").Position;


describe("Puzzle", function () {
    "use strict";
    let puzzle;
    let addRegion0, addRegion1, addRegion2, addRegion3;
    ...
    it("regions can be locked so they are not overwritten by the user", function () {
        ...
        let region0 = puzzle.getRegionByNumber(0);
    ...
    describe("add values to multiple regions", function () {
        ...
        it("cant add invalid horizontal values to second region", function () {
            let result = addRegion1(1, Position.NORTHEAST);
            expect(result).toBeFalsy();
        ...
        it("cant add invalid vertical values to second region", function () {
            let result = addRegion3(1, Position.MIDWEST);
            expect(result).toBeFalsy();

            let region3 = puzzle.getRegionByNumber(3);
